...
<div class="ahb-addons-container ahb-disabled-addons">
	...
	<div class="ahb-addons-group">
		...
		<div class="ahb-addon">
			<label><input type="checkbox" disabled>Credits Purchase: Purchase hours credits</label>
			<p>Allows to purchase some number of hours (credits) and then use those credits to complete bookings</p>
		</div>  
        <div class="ahb-addon">
